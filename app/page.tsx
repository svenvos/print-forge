import { montserrat, albertSans } from "./layout";
        ...
        <main>
            <section className="my-10 px-5 flex flex-col sm:flex-row sm:items-center sm:gap-25 sm:px-10">
                <div className="mb-10 max-w-[600px]">
                    ...
                    <h1 className={`${montserrat.className} mb-5 font-bold text-[2.5rem] sm:text-[3.5rem]`}>Discover what's possible with 3D printing</h1>
                    ...
                    <Link
                        href="/models"
                        className={`p-3 uppercase text-xl ${albertSans.className} font-bold border-2 border-black sm:font-semibold`}
                    >Browse models</Link>
                </div>
                <Image
                    src="/hero-image.png"
